...
abstract class XmlNode extends Iterable<XmlNode> {
   ...
   */
  String toString() => doFormat();

  String doFormat({bool selfCloseTags: false}) {
    var buffer = new StringBuffer();
    writeTo(buffer, selfCloseTags: selfCloseTags);
   ...
   */
  void writeTo(StringBuffer buffer, {bool selfCloseTags: false});
...
class XmlElement extends XmlParent {
  ...
  void writeTo(StringBuffer buffer, {bool selfCloseTags: false}) {
    ...
    if (children.isEmpty && selfCloseTags) {
      buffer.write(' />');
    } else {
      buffer.write('>');
